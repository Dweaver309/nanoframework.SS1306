...
namespace SS1306
{
    class OLED
    {
        ...
        {
            SS1306 = I2cDevice.FromId("I2C1", new I2cConnectionSettings(0x3C) { BusSpeed = I2cBusSpeed.StandardMode });
        ...
        ///     ''' </summary>
        public static void Write(int Horizonal, int line, string str, bool Center = true)
        {
            if (Center)
            {
        ...
        /// </summary>
        public static void ClearLine(int Horizonal, int Line)
        {
